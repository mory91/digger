...
NSDI_FEATURES = [DISK_READS, DISK_WRITES, VIRTUAL_MEMORY, S_TIME,
                 ...
                 NETWORK_OUT, SENDS, SRC_IP, DEST_IP]
ALL_FEATURES = NSDI_FEATURES + [ALLOCS, RSS_MEMORY, DATA_MEMORY, U_TIME, SRC_PORT, DEST_PORT, KCACHE]
...
SYSTEM_FEATURES = [SENDS, DISK_READS, DISK_WRITES, VIRTUAL_MEMORY, S_TIME,
                   ALLOCS, RSS_MEMORY, DATA_MEMORY, U_TIME, KCACHE]
